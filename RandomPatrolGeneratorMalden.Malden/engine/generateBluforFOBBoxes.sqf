...
if (isClass (configFile >> "CfgPatches" >> "ace_medical")) then 
{
	...
	[blufor, 100, [["Land_BagFence_Long_F", 10], ["Land_BagFence_Round_F", 10], ["Land_SandbagBarricade_01_hole_F", 15], ["Land_BagBunker_Small_F", 20], ["Land_BagFence_Long_F", 20]]] call ace_fortify_fnc_registerObjects;
} else 
{
