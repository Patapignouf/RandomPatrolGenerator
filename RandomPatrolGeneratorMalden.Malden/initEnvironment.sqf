...
c_variableToInit = ["listOfRoles","loadout","rifleList","grenadeLauncherList","attachmentLongList","attachmentShortList","smgList","marksmanrifleList","autorifleList","launcherList","itemList","itemEngineerList","itemMedicList",'backPackList','uniformList', "bluforUnarmedVehicle","bluforArmedVehicle","bluforUnarmedVehicleChopper","bluforArmoredVehicle","bluforDrone","bluforBoat","civilian_group",
