...
params ["_supportType"];
	switch (_supportType) do
	{
		...
		case "VehicleShop":
		{
			...
			[["bluforVehicleAvalaibleSpawn", bluforUnarmedVehicle, bluforArmedVehicle, bluforArmoredVehicle, bluforUnarmedVehicleChopper, bluforArmedChopper, bluforDrone, bluforFixedWing, bluforFixedWingTransport, bluforBoat, bluforStaticWeapon], 'GUI\vehicleSpawnerGUI\vehicleSpawner.sqf'] remoteExec ['BIS_fnc_execVM', player];
		};
		case "SupportShop":
		{
			//Close admin menu
