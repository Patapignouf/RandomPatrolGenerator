adjustRole = {
	...
	} else 
	{
		...
		if (["marksman", _cfgName] call BIS_fnc_inString || ["spotter", _cfgName] call BIS_fnc_inString || ["_MRK", _cfgName] call BIS_fnc_inString || ["_RMRK", _cfgName] call BIS_fnc_inString || ["_hunter", _cfgName] call BIS_fnc_inString || ["_scout_", _cfgName] call BIS_fnc_inString) then 
		{
			_cfgRole = "marksman";
		};
