...
//Loadout management////
////////////////////////
listOfRoles_WWII_USA = [c_leader,c_at,c_rifleman,c_engineer,c_autorifleman,c_marksman,c_medic,c_pilot];
