...
_PlayersInArea = (_object nearEntities ["Man", 500]) select {
	isPlayer _x
};

if (count _PlayersInArea == 0) exitWith {false};

_PlayersInArea sort true;

_nearestPlayer = _PlayersInArea select 0;
